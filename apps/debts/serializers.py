...
class DebtSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Debt
        fields = ('id', 'company', 'student', 'student_name', 'student_phone', 'group_name', 'amount', 'due_date', 'status', 'updated_at')
    ...
    def get_group_name(self, obj):
        membership = obj.student.group_memberships.filter(left_at__isnull=True).select_related('group').first()
